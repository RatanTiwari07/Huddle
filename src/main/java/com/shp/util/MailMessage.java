...
public class MailMessage {
	...
	public static void fansMessage(String recipientMailId, String name) {

		String subject = name + ", Thanks for your valuable feedback";
		String htmlTextMessage = "<html> <body> <p> Hey! "+ name +", <br><br> "
				+ "I hope this email finds you well. I wanted to personally thank you for taking the time to provide feedback on "
				+ "your recent experience with Ellison Electronics. Your input is highly valuable to us, and we genuinely appreciate "
				+ " your insights. <br><br>"
				+ "We take all feedback seriously as it helps us enhance our services and make improvements. Your comments have been "
				+ "carefully reviewed, and we're committed to addressing any issues you've raised. Your feedback helps us in our "
				+ "continuous efforts to provide a better shopping experience for our customers. <br><br>"
				+ "We appreciate you bringing this to our attention. We're actively working on a solution to ensure that this does not "
				+ "happen in the future.<br>"
				+ "Your feedback is valuable in helping us make these improvements, and we are grateful for your support in making our "
				+ "e-commerce platform better for everyone. <br>"
				+ "If you have any further questions or suggestions, please feel free to reach out to us. We are here to assist you in "
				+ "any way we can.<br><br>"
				+ "Come shop again! <b>Ellison Electronics</b> </p> </body> </html>";
