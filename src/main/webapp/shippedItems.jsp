...
<%@ page import="com.shp.daoImpl.OrderDaoImpl , com.shp.beans.OrderBean, java.util.List, java.util.ArrayList, 
...
<div class="text-center" style="font-weight:bold; font-size:24px; color:green;">Shipped Orders</div>
		...
		<table class="table table-hover table-sm">
			...
			<tbody style="background-color:white; font-size:16px;">
				...
				<% 
					...
					ordList = new OrderDaoImpl().getAllShippedOrders();
				...
				%>
						<tr>
							...
							<td><a href="./updateProduct.jsp?prodid=<%=order.getProductId()%>"><%=order.getProductId()%></a></td>
							<td><%= userId %></td>
